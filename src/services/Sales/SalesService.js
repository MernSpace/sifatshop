...
const CreateSeleChildsService= async (Request, ParentModel, ChildsModel,updateModel,JoinPropertyName) => {
    ...
    try{
        ...
        //update customer dew
        let customerID = Request.body['Parent']['CustomerID']
        let match = {_id:customerID}
        let update = Request.body['customer'];
...
module.exports=CreateSeleChildsService