...
router.get("/PurchaseDetail/:id",AuthVerifyMiddleware,PurchasesController.detailPurchases);
...
router.get("/SaleDetail/:id",AuthVerifyMiddleware,SalesController.DetailSales);
...
router.get("/ReturnDetail/:id",AuthVerifyMiddleware,ReturnsController.DetailReturns);
